...
import styles from '../styles/Login.module.css'; // Import the CSS file for the styles
...
function Login() {
  ...
  return (
    <div className={styles.session}>
      ...
      <form className={styles['log-in']} onSubmit={handleSubmit} noValidate>
        <h4>We are <span>A SOLVER BOT</span></h4>
        <p>Welcome back!</p>
